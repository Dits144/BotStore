  ...
  head: () => ({
    meta: [
      ...
      { title: "BotStore" },
      {
        name: "description",
        content:
          "Manage your WhatsApp Store Bot: price lists, stock, and groups from a sleek dashboard.",
      },
      { name: "author", content: "Bot Store" },
      { property: "og:title", content: "BotStore" },
      {
        property: "og:description",
        content: "Manage your WhatsApp Store Bot from a sleek dashboard.",
      },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary" },
      { name: "twitter:title", content: "BotStore" },
      { name: "description", content: "WhatsApp Store Dashboard" },
      { property: "og:description", content: "WhatsApp Store Dashboard" },
